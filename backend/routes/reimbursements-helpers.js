...
async function processReimbursementItem(client, reimbursementId, item, itemIndex, itemFilesMap, userId) {
  ...
  const itemResult = await client.query(`
    INSERT INTO reimbursement_items (
      ...
      expense_date, meal_type, people_count, travel_purpose, lodging_city
    )
